      ...
      {isAdmin ? (
        <div className="drawer sm:drawer-open">
          ...
          <div className="drawer-content flex flex-col sm:justify-start sm:items-center my-20 sm:my-2">
            ...
            <div className="max-w-screen-2xl container mx-auto xl:px-10 pb-16">
              <Outlet />
            </div>
          </div>
          <div className="drawer-side drawer-open sm:w-full z-20">
            ...
            <ul className="menu p-4 w-[80%] sm:w-80 min-h-full bg-base-200 text-base-content">
              ...
              <li>
                <Link to="/">
                  <img src={logo} className="w-[60px] md:w-[200px]" alt="" />
                </Link>
              </li>
              <li className="my-3">
              ...
              <li>
                <Link to="/dashboard/manager-booking">
                  {" "}
                  <MdEditSquare /> Xét duyệt đơn hàng
                </Link>
              </li>
              <li>
                <Link to="/dashboard/had-booking">
                  {" "}
                  <MdEditSquare /> Đơn hàng đã hoàn thành
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/dashboard/add-voucher">
                  {" "}
                  <IoBagAddSharp /> Thêm voucher
                </Link>
              </li>
              <li>
                <Link to="/dashboard/add-categories">
                  {" "}
                  <MdLibraryBooks /> Thêm danh mục
                </Link>
              </li>
              <li>
