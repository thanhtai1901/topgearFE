              ...
              <tr key={index} className="text-center">
                ...
                <td className="text-center flex items-center justify-center">
                  {user && user.role === "admin" ? (
                    ...
                    <img
                      className="w-10 h-10 text-center flex justify-center rounded-full"
                    ...
                    <img
                      className="w-10 h-10 text-center rounded-full flex justify-center"
                      src={user?.photoURL}
                      alt=""
                    />
                  ) : (
                ...
                <td>{user.email}</td>
                <td className="text-red text-center flex justify-center">
                  {user.role === "admin" ? (
